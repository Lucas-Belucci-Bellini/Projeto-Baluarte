...
| PHASE 23 — UX / UI Integration | **UI-02 implementado — piloto de contrato** | Shell/layout atual, [`PHASE_UI_DESIGN_SYSTEM.md`](./PHASE_UI_DESIGN_SYSTEM.md), inventário UI-00, contrato UI-01 e [`UI_02_AVAILABILITY_PILOT_2026-08-20.md`](./UI_02_AVAILABILITY_PILOT_2026-08-20.md) | UI-03: adaptador de leitura do Registry no shell, inicialmente em observação/flag de desenvolvimento |
...
O marco `PHASE UI / UI-00` foi concluído como auditoria somente leitura; `UI-01` e `UI-02` foram implementados como contratos/projeções passivas em [`UI_01_NAVIGATION_CONTRACT_2026-08-20.md`](./UI_01_NAVIGATION_CONTRACT_2026-08-20.md) e [`UI_02_AVAILABILITY_PILOT_2026-08-20.md`](./UI_02_AVAILABILITY_PILOT_2026-08-20.md). O próximo marco é `UI-03 — adaptador de leitura do Registry no shell`, inicialmente em observação ou flag de desenvolvimento e sem ocultar rotas globalmente.
