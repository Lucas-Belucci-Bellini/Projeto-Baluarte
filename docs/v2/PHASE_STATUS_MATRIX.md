...
| PHASE 23 — UX / UI Integration | **UI-01 implementada — projeção passiva** | Shell/layout atual, [`PHASE_UI_DESIGN_SYSTEM.md`](./PHASE_UI_DESIGN_SYSTEM.md), [`UI_00_INVENTORY_2026-08-20.md`](./UI_00_INVENTORY_2026-08-20.md) e [`UI_01_NAVIGATION_CONTRACT_2026-08-20.md`](./UI_01_NAVIGATION_CONTRACT_2026-08-20.md) | UI-02: paridade automatizada e piloto de disponibilidade com Registry/health autorizado |
...
O marco `PHASE UI / UI-00` foi concluído como auditoria somente leitura e o `UI-01 — contrato de navegação projetada` foi implementado como projeção passiva em [`UI_01_NAVIGATION_CONTRACT_2026-08-20.md`](./UI_01_NAVIGATION_CONTRACT_2026-08-20.md). O próximo marco é `UI-02 — paridade automatizada e piloto de disponibilidade`, que deve manter o shell compatível e obter health/availability de uma autoridade existente antes de alterar a visibilidade da sidebar.
