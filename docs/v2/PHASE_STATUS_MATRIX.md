...
| PHASE 12 — JARVIS Foundation | **Parcial avançada — visual integrado e orçamento adaptativo Mark XIII** | JARVIS, WebLLM, Hermes, voz, memória, Spotify, contratos, console integrado da rota `/jarvis`, benchmark e degradação visual por FPS/memória; V7 standalone preservado | Medir em hardware real, Tool Registry, permission boundaries, health server-side e fallback documentado |
