...
**Gerado em:** 2026-08-14T23:26:27.265Z
...
Existem **95 páginas JavaScript canônicas restantes**. A onda atual migra quatro: `simbolos.js`, `gerar-codigo.js`, `git-helper.js` e `dolar.js`. Os wrappers de compatibilidade não são contados como dívida funcional.

| Grupo | Páginas restantes |
| --- | ---: |
| Páginas utilitárias e conteúdo | 40 |
| Ferramentas interativas | 16 |
| Hubs e catálogos | 11 |
...
| 45 | `src/pages/gerar-codigo.js` | 129 | 5922 | Ferramentas interativas | médio | onda atual |
| 46 | `src/pages/zomboid-admin.js` | 129 | 5694 | Hubs e catálogos | médio | tipar catálogo, filtros e persistência local |
| 47 | `src/pages/robotica.js` | 107 | 3541 | Hubs e catálogos | médio | tipar catálogo, filtros e persistência local |
| 48 | `src/pages/zomboid.js` | 73 | 2881 | Hubs e catálogos | médio | tipar catálogo, filtros e persistência local |
| 49 | `src/pages/projetos.js` | 61 | 2531 | Hubs e catálogos | médio | tipar catálogo, filtros e persistência local |
| 50 | `src/pages/utilidades.js` | 613 | 31394 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 51 | `src/pages/esteganografia.js` | 440 | 14455 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 52 | `src/pages/perfil.js` | 430 | 20547 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 53 | `src/pages/apis.js` | 366 | 14773 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 54 | `src/pages/morse.js` | 337 | 11688 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 55 | `src/pages/color-studio.js` | 320 | 11599 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 56 | `src/pages/calculadoras/engenharia.js` | 319 | 12387 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 57 | `src/pages/fft.js` | 303 | 9939 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 58 | `src/pages/ia-proprietaria.js` | 289 | 10459 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 59 | `src/pages/calculadoras/financeira.js` | 278 | 9585 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 60 | `src/pages/calculadoras/conversores.js` | 270 | 9883 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 61 | `src/pages/calculadoras/saude.js` | 269 | 10312 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 62 | `src/pages/batalha-naval.js` | 253 | 10301 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 63 | `src/pages/economia.js` | 248 | 8251 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 64 | `src/pages/dolar.js` | 226 | 9262 | Ferramentas interativas | baixo | onda atual |
| 65 | `src/pages/diagnostico.js` | 220 | 9304 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 66 | `src/pages/portas.js` | 213 | 8409 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 67 | `src/pages/json-studio.js` | 211 | 7148 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 68 | `src/pages/poder-militar.js` | 205 | 7752 | Conteúdo militar | baixo | tipar dados estáticos e preservar rota |
| 69 | `src/pages/baixar.js` | 201 | 9296 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 70 | `src/pages/geopulse.js` | 199 | 8125 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 71 | `src/pages/calculadoras/estatistica.js` | 195 | 7119 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 72 | `src/pages/simbolos.js` | 192 | 5937 | Ferramentas interativas | baixo | onda atual |
| 73 | `src/pages/triangulacao.js` | 173 | 7442 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 74 | `src/pages/shadow.js` | 170 | 6837 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 75 | `src/pages/orcamentos-militares.js` | 166 | 7834 | Conteúdo militar | baixo | tipar dados estáticos e preservar rota |
| 76 | `src/pages/guia-pc.js` | 163 | 6032 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 77 | `src/pages/tabela-periodica.js` | 162 | 5848 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 78 | `src/pages/cripto/otp.js` | 161 | 5307 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 79 | `src/pages/comms.js` | 147 | 5521 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 80 | `src/pages/militar.js` | 145 | 8540 | Conteúdo militar | baixo | tipar dados estáticos e preservar rota |
| 81 | `src/pages/cripto/index.js` | 123 | 3807 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 82 | `src/pages/cripto/aes.js` | 122 | 4128 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 83 | `src/pages/seguranca.js` | 120 | 4757 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 84 | `src/pages/git-nexus-gate.js` | 117 | 5572 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 85 | `src/pages/calculadoras/index.js` | 116 | 3430 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 86 | `src/pages/banco.js` | 115 | 4932 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 87 | `src/pages/cripto/base.js` | 101 | 3334 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 88 | `src/pages/_placeholder.js` | 93 | 3129 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 89 | `src/pages/cripto/morse.js` | 88 | 3272 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 90 | `src/pages/arsenal-expandido.js` | 84 | 2933 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 91 | `src/pages/git-helper.js` | 84 | 2868 | Ferramentas interativas | baixo | onda atual |
| 92 | `src/pages/cripto/caesar.js` | 80 | 2610 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 93 | `src/pages/cripto/vigenere.js` | 74 | 2555 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 94 | `src/pages/cripto/hash.js` | 63 | 2099 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
| 95 | `src/pages/cripto/atbash.js` | 58 | 1831 | Páginas utilitárias e conteúdo | baixo | tipar estado local, DOM e dependências diretas |
