...
| [`V2_STACK_REVIEW.md`](./V2_STACK_REVIEW.md) | ✅ **Fase 0** | a revisão de stack MEDIDA — componente a componente, com benchmark; ver [ADR-004](../architecture/decisions/ADR-004-stack-poliglota-por-responsabilidade.md) |
| [`V2_STACK.md`](./V2_STACK.md) | ⛔ superado | primeira tentativa: reavaliou o stack sem questionar se o Core deveria ser JS. Fica pelo inventário e pelo erro de método |
...
| [`v2/bench/`](../../v2/bench/) | a medição da Fase 0: Core em JS, fronteira JS↔WASM com Rust real, e Python/Node/Rust sobre dado do projeto |
...
⚠️ **A Fase 0 mudou o rumo.** O [ADR-004](../architecture/decisions/ADR-004-stack-poliglota-por-responsabilidade.md)
decidiu, com medição, que o Core de Orquestração fica em TypeScript (WASM mediu
4,7× mais lento no despacho real) e que existe um **Core de Runtime em Rust** que
ainda não foi construído. Antes de empilhar mais Core em JS, leia
[`V2_STACK_REVIEW.md`](./V2_STACK_REVIEW.md).
