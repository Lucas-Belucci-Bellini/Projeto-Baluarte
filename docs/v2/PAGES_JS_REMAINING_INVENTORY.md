...
**SHA auditado:** `33a1647c104e5c990de528044c8d3f9a399eb073`
**Gerado em:** 2026-08-15T02:14:43.256Z
...
Existem **50 páginas JavaScript canônicas restantes**. A onda de biblioteca, academia, ciberseg e robotica foi concluída; a próxima onda deve ser escolhida pelo risco documentado. Os wrappers de compatibilidade não são contados como dívida funcional.

| Grupo | Páginas restantes |
| --- | ---: |
| Ferramentas interativas | 12 |
| IA, Nexus e memória | 10 |
| Páginas utilitárias e conteúdo | 10 |
| Mídia, rádio e DSP | 8 |
