...
A auditoria **UI-00** foi concluída em `docs/v2/UI_00_INVENTORY_2026-08-20.md`. Os contratos **UI-01**, **UI-02** e **UI-03 — observação do Registry** foram implementados em `docs/v2/UI_01_NAVIGATION_CONTRACT_2026-08-20.md`, `docs/v2/UI_02_AVAILABILITY_PILOT_2026-08-20.md` e `docs/v2/UI_03_REGISTRY_OBSERVATION_2026-08-20.md`. A próxima subfase recomendada é **UI-04 — reconciliação controlada do catálogo**, sem iniciar uma reescrita ampla da sidebar.
