...
| 06 | Evidence / Wiki contracts | `IN PROGRESS` — preview de retenção publicado | Data, provenance, schemas | Dado externo tratado como fato | Catálogo Zomboid com 159 entradas, Evidence por Registry, summary por status, `reviewQueue` bounded, `retentionPreview` determinístico e integração 50/50 | Source/license/revision required; retenção operacional e revisão humana server-side ausentes | Search/index budgets pendentes | Wiki/Evidence docs e release 1.3.1 | `9b734394` | Auditoria de consumidor, retenção e revisão humana |
...
| 13 | Arma 3 / Zomboid / content platform | `IN PROGRESS` — preview Zomboid/Evidence publicado | Wiki schema, evidence, assets | Conteúdo sem fonte/licença | Wiki Arma 3 e inventário; schema Zomboid local, proveniência, Evidence, fila read-only e preview de retenção | License, provenance, controlled export; retenção operacional e revisão humana server-side ausentes | Index/search budgets pendentes | Wiki roadmap e release 1.3.1 | `9b734394` | Auditoria, retenção operacional e busca |
...
| 22 | Release / environments / rollback | `COMPLETE` for 1.3.1 scope | CI, changelog, SW, tags, desktop artifacts | Release without recovery evidence | v1.3.1 and desktop-v1.3.1 tags, 8/8 assets HTTP 200, Desktop Release 32592402608; Rust local remains blocked-known | No secrets; rollback to v1.3.0 documented | Artifact/bundle warnings known | Changelog, release plan and v1.3.1 note | `9b734394` | Asset checksums and rollback evidence |
