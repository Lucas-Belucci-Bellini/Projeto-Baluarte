...
| 06 | Evidence / Wiki contracts | `IN PROGRESS` — piloto local de revisão publicado | Data, provenance, schemas | Dado externo tratado como fato | Catálogo Zomboid com 159 entradas, Evidence por Registry, summary por status, `reviewQueue` bounded e integração 49/49 | Source/license/revision required; revisão humana server-side ausente | Search/index budgets pendentes | Wiki/Evidence docs e release 1.3.0 | `9ae47cea` | Retenção, busca e revisão humana |
...
| 13 | Arma 3 / Zomboid / content platform | `IN PROGRESS` — piloto Zomboid/Evidence publicado | Wiki schema, evidence, assets | Conteúdo sem fonte/licença | Wiki Arma 3 e inventário; schema Zomboid local, proveniência, Evidence e fila read-only | License, provenance, controlled export; revisão humana server-side ausente | Index/search budgets pendentes | Wiki roadmap e release 1.3.0 | `9ae47cea` | Retenção, busca e revisão humana |
...
| 22 | Release / environments / rollback | `COMPLETE` for 1.3.0 scope | CI, changelog, SW, tags, desktop artifacts | Release without recovery evidence | v1.3.0 and desktop-v1.3.0 tags, 8/8 assets HTTP 200, Desktop Release 32588898329; Rust local remains blocked-known | No secrets; rollback to v1.2.9 documented | Artifact/bundle warnings known | Changelog, release plan and v1.3.0 note | `9ae47cea` | Asset checksums and rollback evidence |
