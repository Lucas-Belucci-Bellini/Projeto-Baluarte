...
| 11 | JARVIS Core / Tools / Memory / Knowledge | `IN PROGRESS` com visual integrado e orçamento adaptativo | Core, evidence, permissions, rota `/jarvis` | Agente ganhar autoridade excessiva ou visual afirmar saúde sem evidência | Contexto, Spotify PKCE, presence, fakes, console Mark XIII, benchmark `jarvis:performance`, orçamento de FPS/memória e fallback local | Opt-in, least privilege, audit pendentes | Hardware real, CPU/memória, prompt/tool/memory benchmark pendentes | JARVIS docs, [`JARVIS_MARK_XIII_INTEGRATED_VISUAL_2026-08-20.md`](./JARVIS_MARK_XIII_INTEGRATED_VISUAL_2026-08-20.md) e [`JARVIS_MARK_XIII_PERFORMANCE_MATRIX_2026-08-20.md`](./JARVIS_MARK_XIII_PERFORMANCE_MATRIX_2026-08-20.md) | `50891ae2` publicado | Tool registry e baseline de custo |
