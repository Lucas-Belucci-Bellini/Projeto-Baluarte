...
**Branch oficial:** `main`
**SHA observado:** `d3d23651f23d0ad3164ad6bc1881e7085c31a8a7`
...
| 11 | JARVIS Core / Tools / Memory / Knowledge | `IN PROGRESS` com visual integrado | Core, evidence, permissions, rota `/jarvis` | Agente ganhar autoridade excessiva ou visual afirmar saúde sem evidência | Contexto, Spotify PKCE, presence, fakes, console Mark XIII e fallback local | Opt-in, least privilege, audit pendentes | CPU/memória do canvas, prompt/tool/memory benchmark pendentes | JARVIS docs e [`JARVIS_MARK_XIII_INTEGRATED_VISUAL_2026-08-20.md`](./JARVIS_MARK_XIII_INTEGRATED_VISUAL_2026-08-20.md) | `d3d23651` base / novo marco pending | Tool registry e baseline de custo |
...
| 21 | Performance / accessibility / UX audit | `IN PROGRESS` parcial | All surfaces | Claiming light/fast without measurement | Harness UI keyboard/focus/reduced-motion matrix; smoke/path critical | Reduced motion implemented only in harness; server-side accessibility evidence absent | Boot, route, DB, JARVIS, mobile budgets missing | Design docs and [`COMMAND_CENTER_A11Y_MATRIX_2026-08-20.md`](./COMMAND_CENTER_A11Y_MATRIX_2026-08-20.md) | `d3d23651` publicado | Observability and measured matrix |
