...
| 06 | Data Layer | `IN PROGRESS` | Storage, schema, migration, validation | Manus AI | Acesso direto e geradores incompatíveis com TS | Storage, offline e persistência local verdes | Classificação, backup e recuperação incompletos | Latência e tamanho de dados sem orçamento geral | `2f660dc6` | Docs de storage e baseline | Corrigir contrato dos geradores sem alterar catálogo manualmente |
...
2. **Corrigir o contrato dos geradores Node/TypeScript** (`GEN-TS-001`) sem editar artefatos para satisfazer o gate.
