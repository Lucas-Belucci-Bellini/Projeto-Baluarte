...
**Branch oficial:** `main`
**SHA observado:** `1154d60d0dbc4ed2a5c65e7fda393a71fcf74c2d`
...
| 21 | Performance / accessibility / UX audit | `IN PROGRESS` parcial | All surfaces | Claiming light/fast without measurement | Harness UI keyboard/focus/reduced-motion matrix; smoke/path critical | Reduced motion implemented only in harness; server-side accessibility evidence absent | Boot, route, DB, JARVIS, mobile budgets missing | Design docs and [`COMMAND_CENTER_A11Y_MATRIX_2026-08-20.md`](./COMMAND_CENTER_A11Y_MATRIX_2026-08-20.md) | `1154d60d` publicado | Observability and measured matrix |
