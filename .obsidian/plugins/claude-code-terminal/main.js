...
var VIEW_TYPE_CLAUDE_TERMINAL = "claude-terminal-view";
...
var ClaudeTerminalView = class extends import_obsidian.ItemView {
  ...
  onPaneMenu(menu) {
    menu.addItem((item) => {
      item.setTitle("Undock to floating window").setIcon("arrow-up-right").onClick(() => this.plugin.undockToFloating());
    });
    menu.addItem((item) => {
      item.setTitle("Clear terminal").setIcon("eraser").onClick(() => this.sendClear());
    });
  }
  sendClear() {
    var _a;
    (_a = this.ptyProcess) == null ? void 0 : _a.write("clear\r");
  }
  async onClose() {
    await super.onClose();
  ...
  startPty() {
    ...
    try {
      ...
      this.terminal.onData((data) => {
        var _a2;
        (_a2 = this.ptyProcess) == null ? void 0 : _a2.write(data);
      });
      this.terminal.onResize(({ cols, rows }) => {
        var _a2;
        (_a2 = this.ptyProcess) == null ? void 0 : _a2.resize(cols, rows);
      });
      if (this.plugin.settings.autoLaunchClaude) {
        setTimeout(() => {
          var _a2;
          (_a2 = this.ptyProcess) == null ? void 0 : _a2.write("clear && claude\r");
        }, 300);
      }
    } catch (error) {
      console.error("Claude Terminal: Failed to start PTY", error);
      (_a = this.terminal) == null ? void 0 : _a.write("\r\n\x1B[31mError: Failed to start terminal.\x1B[0m\r\n");
...
`);
  ...
  clearTerminal() {
    var _a;
    (_a = this.terminal) == null ? void 0 : _a.clear();
  }
  focusTerminal() {
    var _a;
...
var ClaudeTerminalPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    ...
    this.floatingFitDebounceTimer = null;
  }
  async onload() {
  ...
  createFloatingContainer() {
    ...
    (0, import_obsidian.setIcon)(clearBtn, "plus");
    clearBtn.title = "Clear terminal";
    clearBtn.addEventListener("click", () => {
      var _a;
      return (_a = this.floatingPtyProcess) == null ? void 0 : _a.write("clear\r");
    });
    const dockBtn = headerRight.createEl("button", { cls: "claude-terminal-btn clickable-icon", attr: { "aria-label": "Open in sidebar" } });
    (0, import_obsidian.setIcon)(dockBtn, "layout-sidebar-right");
    ...
    (0, import_obsidian.setIcon)(minBtn, "minus");
  ...
  setupFloatingDrag(header) {
    let isDragging = false;
    let startX, startY;
    let startRight, startBottom;
    const onMouseMove = (e) => {
      if (!isDragging || !this.floatingContainer)
        return;
    ...
    header.addEventListener("mousedown", (e) => {
      if (e.target.closest(".claude-terminal-btn"))
        return;
      isDragging = true;
      startX = e.clientX;
      startY = e.clientY;
  ...
  setupFloatingResize(handle) {
    ...
    handle.addEventListener("mousedown", (e) => {
      ...
      startX = e.clientX;
      startY = e.clientY;
      startWidth = ((_a = this.floatingContainer) == null ? void 0 : _a.offsetWidth) || 500;
      startHeight = ((_b = this.floatingContainer) == null ? void 0 : _b.offsetHeight) || 350;
      document.addEventListener("mousemove", onMouseMove);
      document.addEventListener("mouseup", onMouseUp);
      e.preventDefault();
    });
  ...
  initializeFloatingTerminal() {
    var _a;
    const content = (_a = this.floatingContainer) == null ? void 0 : _a.querySelector(".claude-terminal-content");
    if (!content)
      return;
    const theme = this.getObsidianTheme();
    this.floatingTerminal = new import_xterm.Terminal({
    ...
    this.floatingFitAddon = new import_addon_fit.FitAddon();
    this.floatingTerminal.loadAddon(this.floatingFitAddon);
    this.floatingTerminal.open(content);
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        if (this.floatingFitAddon && this.floatingTerminal) {
          this.floatingFitAddon.fit();
    ...
    this.floatingResizeObserver = new ResizeObserver(() => {
      if (this.floatingFitDebounceTimer)
        clearTimeout(this.floatingFitDebounceTimer);
  ...
  startFloatingPty() {
    ...
    try {
      ...
      this.floatingPtyProcess.onData((data) => {
        var _a2;
        (_a2 = this.floatingTerminal) == null ? void 0 : _a2.write(data);
      });
      this.floatingTerminal.onData((data) => {
        var _a2;
        (_a2 = this.floatingPtyProcess) == null ? void 0 : _a2.write(data);
      });
      this.floatingTerminal.onResize(({ cols, rows }) => {
        var _a2;
        (_a2 = this.floatingPtyProcess) == null ? void 0 : _a2.resize(cols, rows);
      });
      if (this.settings.autoLaunchClaude) {
        setTimeout(() => {
          var _a2;
          (_a2 = this.floatingPtyProcess) == null ? void 0 : _a2.write("clear && claude\r");
        }, 300);
      }
    } catch (error) {
      console.error("Claude Terminal: Failed to start PTY", error);
      (_a = this.floatingTerminal) == null ? void 0 : _a.write("\r\n\x1B[31mError: Failed to start terminal.\x1B[0m\r\n");
    }
  }
  destroyFloatingTerminal() {
    var _a, _b;
    (_a = this.floatingResizeObserver) == null ? void 0 : _a.disconnect();
    this.floatingResizeObserver = null;
    ...
    this.floatingFitAddon = null;
    const content = (_b = this.floatingContainer) == null ? void 0 : _b.querySelector(".claude-terminal-content");
    if (content) {
      content.empty();
    }
  }
  ...
  showFloatingTerminal() {
    ...
    if (!this.floatingTerminal) {
      ...
      (_a = this.floatingFitAddon) == null ? void 0 : _a.fit();
      this.floatingTerminal.scrollToBottom();
      this.floatingTerminal.focus();
    }
  }
...
var ClaudeTerminalSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Shell path").setDesc("Path to the shell executable").addText(
      (text) => text.setPlaceholder("/bin/zsh").setValue(this.plugin.settings.shellPath).onChange(async (value) => {
        this.plugin.settings.shellPath = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("Auto-launch claude").setDesc("Automatically run 'claude' command when terminal opens").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.autoLaunchClaude).onChange(async (value) => {
        this.plugin.settings.autoLaunchClaude = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("Font size").setDesc("Terminal font size in pixels").addSlider(
      (slider) => slider.setLimits(10, 24, 1).setValue(this.plugin.settings.fontSize).setDynamicTooltip().onChange(async (value) => {
