...
| **Web/Desktop** | `1.3.2` em validação | Candidata com auditoria estrutural local bounded da Evidence, sem mutação; a release pública anterior é `1.3.1`. V1 preservada e V2 em construção incremental. |
...
| Release 1.3.2 — auditoria estrutural Evidence | [`v1.3.2.md`](docs/releases/v1.3.2.md) | Candidata em validação; publicação depende de gates, CI, tags e artefatos desktop verificáveis. |
