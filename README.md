...
| Release 1.3.7 — o Núcleo vira o palco | [`v1.3.7.md`](docs/releases/v1.3.7.md) | Conversa e config passam a abrir em camadas sobre o Núcleo, pelos botões do próprio HUD, sem a página crescer para baixo. |
