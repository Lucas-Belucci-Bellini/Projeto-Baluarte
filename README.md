...
| **Web/Desktop** | `1.2.8` publicada | Release com o piloto Wiki Zomboid/Evidence, instaladores Windows, Linux e macOS verificados e todos os gates aplicáveis verdes. V1 preservada e V2 em construção incremental. |
