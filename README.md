...
| Release 1.3.8 — o Núcleo sabe o que toca na máquina | [`v1.3.8.md`](docs/releases/v1.3.8.md) | Publicada com a tag `v1.3.8`; oito assets e os três manifests verificados. Leitura nativa do SMTC do Windows: título e artista de qualquer player, sem conta e sem OAuth. Só no app. |
