...
| **Web/Desktop** | `1.3.1` publicada | Release com preview local bounded de retenção Evidence, sem mutação; instaladores Windows, Linux e macOS verificados. V1 preservada e V2 em construção incremental. |
