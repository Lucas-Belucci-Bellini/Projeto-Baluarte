...
| **Web/Desktop** | `1.3.7` publicada | A `1.3.5` dividiu a rota `/jarvis` por ambiente (web = só o Núcleo V7; app = o JARVIS completo) e pôs o Spotify a um clique. A `1.3.6` fez o Núcleo saber o que toca e captar o som real do PC. A `1.3.7` transforma o Núcleo em palco: conversa e config abrem em camadas sobre ele, pelos botões do próprio HUD. |
