...
| **Web/Desktop** | `1.3.8` em publicação | A `1.3.6` fez o Núcleo captar o som real do PC. A `1.3.7` transformou o Núcleo em palco: conversa e config em camadas sobre ele. A `1.3.8` faz o Núcleo saber o que toca na máquina pelo SMTC do Windows — sem conta, sem OAuth, e para qualquer player, não só o Spotify. |
...
| Release 1.3.0 — fila local de revisão Evidence | [`v1.3.0.md`](docs/releases/v1.3.0.md) | Publicada com tags `v1.3.0` e `desktop-v1.3.0`; oito assets, manifests e instaladores verificados. |
...
| Release 1.3.6 — presença musical e som real do PC | [`v1.3.6.md`](docs/releases/v1.3.6.md) | Publicada com a tag `v1.3.6`; oito assets e os três manifests verificados. O Núcleo passa a saber o que toca no Spotify e a captar o áudio do sistema para o espectrómetro acompanhar. |
| Release 1.3.7 — o Núcleo vira o palco | [`v1.3.7.md`](docs/releases/v1.3.7.md) | Publicada com a tag `v1.3.7`; oito assets e os três manifests verificados. Conversa e config passam a abrir em camadas sobre o Núcleo, pelos botões do próprio HUD, sem a página crescer para baixo. |
| Release 1.3.8 — o Núcleo sabe o que toca na máquina | [`v1.3.8.md`](docs/releases/v1.3.8.md) | Leitura nativa do SMTC do Windows: título e artista de qualquer player, sem conta e sem OAuth. Só no app. |
