...
| **Web/Desktop** | `1.3.0` publicada | Release com fila local bounded e read-only para revisão de Evidence pendente; instaladores Windows, Linux e macOS verificados. V1 preservada e V2 em construção incremental. |
