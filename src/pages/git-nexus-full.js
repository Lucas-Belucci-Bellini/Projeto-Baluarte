/**
 * /git-nexus (experiência COMPLETA) — núcleo unificado de código (#204/#194/#195).
 *
 * ⚠️ Módulo PESADO (mega-plano #238, Fase 2): importa o grafo 3D, o `codemap` e o
 * `codemap-symbols` (~460 KB) + o jarvis-brain. Por isso ele NÃO é importado
 * estaticamente: o gate leve em `git-nexus.js` só faz `import()` deste arquivo
 * dentro do app (`window.baluarte.native`). Na web puro este chunk nunca é
 * baixado — a rota mostra o teaser "baixe o app". Mantém o boot do site leve.
 *
