/**
 * Home v2 — "Command Deck" (PREVIEW em /home2). Proposta NOVA de home, distinta
 * da atual: hero holográfico sobre fundo HUD animado + **grid bento** (estilo
 * AI-landing) + prateleiras com snap. Tudo leve (CSS/canvas, JS puro), reusa o
 * herói WebGL existente (cai no campo 2D sem WebGL). #246/#195.
 *
 * É preview pra aprovação — se aprovado, vira a /home oficial.
 */
...
/* ===== Prateleiras ===== */
function shelf(title, sub, cards, morePath) {
