...
export const A3VAN_TOTAL_TOPICOS = 42;
export const A3ARM_TOTAL = 106;
export const A3ACC_TOTAL = 3218;
export const A3VEI_TOTAL = 5425;
export const A3EQP_TOTAL = 987;
export const A3SOL_TOTAL = 44761;
export const A3TER_TOTAL = 31;
export const A3MUN_TOTAL = 472;
export const A3MAG_TOTAL = 1432;
export const A3COL_TOTAL = 237;
export const A3TUT_TOTAL = 109;
export const A3CFG_TOTAL_TOPICOS = 19;
export const A3CMD_TOTAL = 21;
export const A3CAMP_TOTAL = 14;
export const A3DRV_TOTAL = 19;
export const ARMA3_TOTAL_MODS = 334;
