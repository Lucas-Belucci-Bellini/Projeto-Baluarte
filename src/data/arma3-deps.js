/**
 * Dependências oficiais (seção "Required Items" do Steam Workshop) dos mods
 * do preset "projeto baluarte vercel app". GERADO POR SCRIPT a partir das
 * páginas do Workshop — não editar na mão (regenerar com gerar-deps.mjs).
 */

export const A3TUT_DEPS = {
  "463939057": [
    "CBA_A3"
  ],
  "497660133": [
