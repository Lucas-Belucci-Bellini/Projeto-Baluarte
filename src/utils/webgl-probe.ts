...
function isWebGLContext(value: RenderingContext | null): value is WebGLContext {
  return value !== null && 'getExtension' in value;
}

/** Sonda se há WebGL e se é a versão 2. */
export function sondarWebGL(): WebGLProbeResult {
  ...
  try {
    ...
    gl = gl2 ?? (isWebGLContext(legacy) ? legacy : null);
    return { ok: gl !== null, webgl2: gl2 !== null };
  } catch {
...
export function liberar(gl: WebGLContext | null): void {
