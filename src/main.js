...
import { gitHelperPage } from './pages/git-helper.js';
...
import { esteganografiaPage } from './pages/esteganografia.js';
import { graficosPage } from './pages/graficos.js';
import { simbolosPage } from './pages/simbolos.js';
import { colorStudioPage } from './pages/color-studio.js';
...
import { jarvisVisionPage } from './pages/jarvis-vision.js';
...
import { armasPorPaisPage } from './pages/armas-por-pais.js';
import { guerrasConflitosPage } from './pages/guerras-conflitos.js';
import { batalhasHistoricasPage } from './pages/batalhas-historicas.js';
...
router.register('/git-helper', () => gitHelperPage());
...
router.register('/esteganografia', () => esteganografiaPage());
router.register('/graficos', () => graficosPage());
router.register('/simbolos', () => simbolosPage());
router.register('/color-studio', () => colorStudioPage());
...
router.register('/jarvis-vision', () => jarvisVisionPage());
...
router.register('/armas-por-pais', () => armasPorPaisPage());
router.register('/guerras-conflitos', () => guerrasConflitosPage());
router.register('/batalhas-historicas', () => batalhasHistoricasPage());
