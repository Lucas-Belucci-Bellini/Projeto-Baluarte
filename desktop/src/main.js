...
/* A linha pública 1.0.0 foi pulada; 1.1.0 é a primeira release pós-salto.
 *
...
function setupUpdates() {
  ...
  autoUpdater.on('update-available', (info) => {
    ...
    dialog.showMessageBox(win, {
      ...
      detail:
        'A 1.1.0 é a primeira release pública após o salto planejado. Ela inclui ' +
        'bundles TypeScript compilados, contratos V2 e atualização do fallback offline. ' +
