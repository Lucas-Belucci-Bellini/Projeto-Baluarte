...
export const DOCTOR_CHECKS = Object.freeze([
  ...
  { id: 'module_registry_health', category: 'security-local', command: 'node scripts/module-registry-health-check.mjs', executable: 'node', args: ['scripts/module-registry-health-check.mjs'], policy: SAFE },
