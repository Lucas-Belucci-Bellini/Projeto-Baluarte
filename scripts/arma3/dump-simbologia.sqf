...
//
//   MARCADORES  — os símbolos de carta do jogo, que seguem a APP-6 da OTAN
//                 (infantaria, blindado, artilharia, posto de comando…). É o
//                 elo que faltava entre o Centro Militar, que fala de
//                 organização militar em texto, e um símbolo de verdade.
...
//                 da divisa.
//   INSÍGNIAS   — CfgUnitInsignia: os brasões de unidade, com autor.
//
// FORMATO:
...
// Ausente tem de virar campo VAZIO, não zero: zero é um valor legítimo aqui
...
// ── cores de marcador ─────────────────────────────────────────────────────
{
    ...
    // A cor pode vir como número ou como expressão de cor do jogo; só os
    // numéricos viram RGBA. O resto sai vazio em vez de virar 0.
    private _v = [];
